...
company_update = data.setdefault("company_update", {})
company_update.setdefault("hospital_id", "")
company_update.setdefault("hospital_area_code", "")
company_update.setdefault("hospital_area_id", "")
company_update.setdefault("dept_code", "")
company_update.setdefault("dept_id", "")
