...
MANUFACTURER="${PRINTER_MANUFACTURER:-KICKPI}"
PRODUCT="${PRINTER_PRODUCT:-K2B USB Printer}"
SERIAL="${PRINTER_SERIAL:-K2B-H618-PRINTER-001}"
PNP_STRING="${PRINTER_PNP_STRING:-MFG:KICKPI;MDL:K2B USB Printer;DES:K2B USB Printer;CMD:PJL,PCL,PCLXL,POSTSCRIPT,RAW;CLS:PRINTER;}"
